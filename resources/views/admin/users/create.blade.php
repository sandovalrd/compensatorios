...
@section('content')
	...
	{!! Form::open(['route'=>'users.store', 'method'=>'POST', 'class'=>'form-horizontal', 'id'=>'form']) !!}
		...
		<div class="form-group">
			...
			<div class="col-md-7">
				{!! Form::text('username', null, ['class'=>'form-control', 'placeholder'=>'Indicador de Red', 'autofocus'=>'autofocus' ,'required']) !!}
			</div>
		</div>
		...
		<div class="form-group">
			{!! Form::label('name','Agregar a la Guardia:', ['class' => 'text-right control-check-label col-md-3']) !!}
			<div class="col-md-7">
				{!! Form::checkbox('agregar', true, false, ['class' => 'form-check-input']) !!}
			</div>
		</div>
